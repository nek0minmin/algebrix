...
import 'package:algebrix/data/module6/m6_l6_content.dart';
import 'package:algebrix/data/module6/m6_l7_content.dart';
...
final module6 = ModuleContent(
  ...
  description:
      ...
      'model, and run that model backwards to factor — then build them out of '
      'tiles you can actually arrange.',
  icon: '🔷',
  xyDialogue:
