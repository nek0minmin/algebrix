...
const m2Lesson7 = LessonContent(
  ...
  steps: [
    ...
    LessonStep(
      ...
      choices: [
        ChoiceOption(label: '3x and 3y', emoji: '🔍'),
        ChoiceOption(label: '5x and 2x', emoji: '✅', isCorrect: true),
        ChoiceOption(label: '4x and 4x²', emoji: '🔍'),
        ChoiceOption(label: '7 and 7y', emoji: '🔍'),
      ],
    ...
    LessonStep(
      ...
      choices: [
        ChoiceOption(label: '9', emoji: '❌'),
        ChoiceOption(label: '9x', emoji: '✅', isCorrect: true),
        ChoiceOption(label: '9x²', emoji: '❌'),
        ChoiceOption(label: '18x', emoji: '❌'),
      ],
      correctChoiceIndex: 1,
      isAnswerStep: true,
      xyAsset: AppAssets.xyPointing,
    ...
    LessonStep(
      ...
      choices: [
        ChoiceOption(label: 'The coefficients are the same.', emoji: '❌'),
        ChoiceOption(
          label: 'Both terms represent groups of the same variable.',
          emoji: '💡',
          isCorrect: true,
        ),
        ChoiceOption(label: 'Every addition can be combined.', emoji: '❌'),
        ChoiceOption(label: 'x always equals 1.', emoji: '❌'),
      ],
      correctChoiceIndex: 1,
      isAnswerStep: true,
      xyAsset: AppAssets.xyExplaining,
    ...
    LessonStep(
      ...
      choices: [
        ChoiceOption(label: '3x + 4', emoji: '❌'),
        ChoiceOption(label: '3x + 12', emoji: '✅', isCorrect: true),
    ...
    LessonStep(
      ...
      choices: [
        ChoiceOption(label: '6x + 8', emoji: '✅', isCorrect: true),
        ChoiceOption(label: '14x', emoji: '❌'),
        ChoiceOption(label: '6x + 15', emoji: '❌'),
        ChoiceOption(label: '8x + 6', emoji: '❌'),
      ],
    ...
    LessonStep(
      ...
      choices: [
        ChoiceOption(label: 'Associative Property', emoji: '🔍'),
        ChoiceOption(label: 'Commutative Property', emoji: '✅', isCorrect: true),
        ChoiceOption(label: 'Identity Property', emoji: '🔍'),
        ChoiceOption(label: 'Distributive Property', emoji: '🔍'),
      ],
      correctChoiceIndex: 1,
      isAnswerStep: true,
    ...
    LessonStep(
      ...
      choices: [
        ChoiceOption(label: '14', emoji: '✅', isCorrect: true),
        ChoiceOption(label: '18', emoji: '❌'),
        ChoiceOption(label: '20', emoji: '❌'),
        ChoiceOption(label: '24', emoji: '❌'),
      ],
      correctChoiceIndex: 0,
      isAnswerStep: true,
      xyAsset: AppAssets.xyPointing,
    ...
    LessonStep(
      ...
      choices: [
        ...
        ChoiceOption(label: 'Because parentheses always mean add 6.', emoji: '❌'),
        ChoiceOption(label: 'Because x equals 3.', emoji: '❌'),
        ChoiceOption(label: 'Because 2 + 3 = 5 and 5 + 1 = 6.', emoji: '❌'),
      ],
      correctChoiceIndex: 0,
      isAnswerStep: true,
      xyAsset: AppAssets.xyExplaining,
    ...
    LessonStep(
      ...
      choices: [
        ChoiceOption(label: '5x + 6', emoji: '✅', isCorrect: true),
        ChoiceOption(label: '3x + 8', emoji: '❌'),
        ChoiceOption(label: '5x + 2', emoji: '❌'),
        ChoiceOption(label: '11x', emoji: '❌'),
      ],
      correctChoiceIndex: 0,
      isAnswerStep: true,
      xyAsset: AppAssets.xyPointing,
    ...
    LessonStep(
      ...
      choices: [
        ChoiceOption(label: '15', emoji: '🎉', isCorrect: true),
        ChoiceOption(label: '14', emoji: '❌'),
        ChoiceOption(label: '16', emoji: '❌'),
        ChoiceOption(label: '22', emoji: '❌'),
      ],
      correctChoiceIndex: 0,
      isAnswerStep: true,
      xyAsset: AppAssets.xyHappy,
